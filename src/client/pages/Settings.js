...
export default {
    ...
    render({ logout, toggleDukcy, showDucky, pinkDucky, experimentsTab, cachedGrades, isDecember }) {
    ...
    mounted() {
        ...
        this.experimentsTab = Object.keys(experiments).length;
        this.pinkDucky = experiments['pinkTheme'];
